...
def test1() -> None:
    ...
    assert repeated.measurements[0].latency_ns == 10
...
def test3() -> None:
    ...
    result = WorkerCountTuner(repeat=1).select(
    ...
    WorkerCountTuner(maxnum=None, repeat=1).select(
...
def test4() -> None:
    ...
    tuner = SingleCoreTuner(maxnum=4, repeat=1)
    ...
    SingleCoreTuner(repeat=1).select(
        context,
